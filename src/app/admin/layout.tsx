import { LayoutDashboard, Users, BookOpen, FileCheck, DollarSign, LogOut, CalendarDays } from "lucide-react"
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
            <aside className="w-full md:w-64 bg-slate-900 text-white flex flex-col">
                ...
                <nav className="flex-1 py-6 px-4 space-y-2">
                    ...
                    <Link href="/admin/turmas" className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors hover:bg-slate-800 text-slate-300">
